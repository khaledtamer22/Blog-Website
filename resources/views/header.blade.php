...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>{{str_replace("_"," ",config('app.name'))}} &mdash; </title>
	<style>
		img{
			width: 100%;
			height: 100%;
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			<figure>
				<a href="{{url('/')}}"><img src="{{url('assets/images/person1.png')}}" alt="Documenting the events of my life" class="img-responsive"></a>
			</figure>
			<h3 class="heading">About Me</h3>
			<h2>Khaled's Blog</h2>
			<p>You will see some sides of my life here</p>
